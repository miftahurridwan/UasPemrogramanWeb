<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM kas WHERE id_km='".$_GET['kode']."'";
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type='hidden' class="form-control" name="id_km" value="<?php echo $data_cek['id_km']; ?>" readonly/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" id="keluar" name="keluar" value="Rp<?php echo $data_cek['keluar']; ?>"/>
        </div>
      </div>
    ...
    <div class="card-footer">
      ...
      <a href="?page=o_data_kas" title="Kembali" class="btn btn-secondary">Batal</a>
    </div>
  </form>
</div>
