<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=i_data_kas" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO kas (tgl_km,uraian_km,masuk,keluar,jenis) VALUES (
        '".$_POST['tgl_km']."',
        '".$_POST['uraian_km']."',
        '".$masuk_hasil."',
        '0',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=i_data_kas';
          }
      })</script>";
      }else{
      echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=i_add_kas';
          }
      })</script>";
    }}
