<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" id="Kepala_keluarga" name="kepala_keluarga" placeholder=" Nama Kepala keluarga" required>
       </div>
     </div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO data_warga (kepala_keluarga,jumlah_keluarga,alamat) VALUES (
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=i_add_warga';
          }
      })</script>";
    }}
